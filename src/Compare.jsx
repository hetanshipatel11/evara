            ...
            <tr>
              ...
              <td>
                <ul class="color__list compare__colors">
                  <li>
                    <a href="#" class="color__link" style={{ backgroundColor: " hsl(37, 100%,  65%)" }}></a>
                  </li>
                  <li>
                    <a href="#" class="color__link" style={{ backgroundColor: " hsl(353, 100%, 65%)" }}></a>
                  </li>
                  <li>
                    <a href="#" class="color__link" style={{ backgroundColor: " hsl(49, 100%, 60%)" }}></a>
                  </li>
                </ul>
              </td>
              <td>
